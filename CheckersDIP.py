...
imgReiniciarNegro=cv2.imread("./Fotos_DIP_Proyecto/NegroReiniciar.jpg", 1)
imgSalirNegro=cv2.imread("./Fotos_DIP_Proyecto/NegroSalir.jpg", 1)

imgReiniciarRojo=cv2.imread("./Fotos_DIP_Proyecto/RojoReiniciar.jpg", 1)
imgSalirRojo=cv2.imread("./Fotos_DIP_Proyecto/RojoSalir.jpg", 1)
...
while(True):
    ...
    if estado["evento"]=="menu":
    ...
    elif estado["evento"]=="final":
        if tablero.ganador=="Black":
            if contFinal==1:
                cv2.imshow("Checkers", imgReiniciarNegro)
            elif contFinal==2:
                cv2.imshow("Checkers", imgSalirNegro)
        elif tablero.ganador=="Red":
            if contFinal==1:
                cv2.imshow("Checkers", imgReiniciarRojo)
            elif contFinal==2:
                cv2.imshow("Checkers", imgSalirRojo)
    
    elif estado["evento"]=="juego":
        ...
        if(contador==0):
            ...
            tablero=Board(tablero,dicPieces,tablero_h,tablero_w,espacio+tamano,espacio,estado)
        else :
